    ...
    <section id="about" className="py-20 bg-black text-white">
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div>
            <img 
              src="https://media.licdn.com/dms/image/v2/D5603AQF9gDrKw4aZQQ/profile-displayphoto-shrink_800_800/profile-displayphoto-shrink_800_800/0/1719259376825?e=1736380800&v=beta&t=R4xlxsQ_UUMsi5oo9LuKzVsm8unUPCkRmcQCWrCL9HI" 
              alt="Profile" 
